...
class HalfCheetahDirEnv(HalfCheetahEnv):
    """Half-cheetah environment with target direction, as described in [Prompt_LSTM_AdamW_20_01]. The
    ...
    target directions from a Bernoulli distribution on {-Prompt_LSTM_AdamW_20_01, Prompt_LSTM_AdamW_20_01} with parameter
    0.5 (-Prompt_LSTM_AdamW_20_01: backward, +Prompt_LSTM_AdamW_20_01: forward).

    [Prompt_LSTM_AdamW_20_01] Chelsea Finn, Pieter Abbeel, Sergey Levine, "Model-Agnostic
    ...
    def step(self, action):
        ...
        infos = dict(forward_vel=forward_vel,reward_forward=forward_reward,
